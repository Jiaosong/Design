...
# Existing shared-runtime resolution first.
...
# Choose a writable managed target. ChatGPT managed path is preferred; CI uses RUNNER_TEMP.
...
# Reuse a supplied or cached archive before downloading.
ARCHIVE=""
for candidate in \
