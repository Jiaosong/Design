...
Open the actual SVG/PNG/PDF/interactive output. Run compact-size, grayscale/non-color, label-collision and source-value checks. Renderer/library capability does not substitute for Professional Design Gate.
