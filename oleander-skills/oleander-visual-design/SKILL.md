---
name: oleander-visual-design
description: Develop and refine Oleander visual systems for graphic design, branding, layout, typography, packaging/POP presentation, exhibition graphics, boards, and cross-media visual hierarchy.
compatibility: Candidate reusable skill. Prefer editable vector/repo-native sources such as SVG/HTML/CSS/PDF-compatible vector workflows. Specialist commercial software may be used only when actually available and required by the native output.
---

# Oleander Visual Design

Turn claims, content, brand identity, imagery and project evidence into a distinct visual system with strong first-read hierarchy and professional finish.
...
- first-read and dominant mass;
- claim hierarchy and information density;
- typography family/weight/scale/leading/tracking;
- grid, alignment, spacing and whitespace;
- image-text relation and crop;
...
1. Existing Mature Design First: preserve stronger current work and repair weak layers before redesigning the whole system.
2. Layout must not distort authoritative geometry, data, dimensions, maps, plans, sections or product facts.
3. Marketing impact cannot be created by hiding claim-bearing evidence or overstating product/project truth.
4. Formal text stays editable/vector when required for delivery, localization or technical control.
...
This skill is Candidate. It may be trained and reapplied in bounded project work, but cannot self-promote to ACTIVE or grant Independent KEEP.