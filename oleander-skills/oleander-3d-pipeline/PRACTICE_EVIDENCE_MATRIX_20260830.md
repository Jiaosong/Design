...
| FreeCAD parametric CAD | Modeling Essence + Parametric Design + `EVD-CAD-FREECAD-1_1-20260830-001` | `PRAC-20260830-3D-04` parametric STEP + `PRAC-20260831-3D-11` B-Spline revolve | `RECOVERED_NATIVE` FreeCAD 1.1.3: parametric CAD and OpenCASCADE B-Spline/STEP/native reopen | M6 only for explicitly tested dependency/roundtrip and B-Spline same-source propositions; not Fusion/Rhino parity | datum/reference-change robustness, Sketcher constraints, assembly/fit; Rhino/Fusion remain separate HOLD |
