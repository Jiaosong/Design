...
from .design_intent_rebuild import OPERATOR_CLASSES as DESIGN_INTENT_REBUILD_OPERATOR_CLASSES
from .design_intent_rebuild import PANEL_CLASSES as DESIGN_INTENT_REBUILD_PANEL_CLASSES
...
OPERATOR_CLASSES = (
    ...
    *DESIGN_INTENT_REBUILD_OPERATOR_CLASSES,
...
PANEL_CLASSES = (
    ...
    *DESIGN_INTENT_REBUILD_PANEL_CLASSES,
)
