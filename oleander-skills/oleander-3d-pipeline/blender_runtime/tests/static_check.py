...
contracts, twelve independently fingerprint-bound real-Blender receipts,
...
STAGES = [
    {
        ...
        "failures": {
            "duplicate_ole_id_detect_and_repair",
    ...
    },
    {
        ...
        "checks": {
            ...
            "shell_modifier_feature", "bevel_chamfer_modifier_feature",
            "mirror_modifier_feature", "linear_pattern_modifier_feature",
            "linear_pattern_metric_spacing", "feature_history_stable_ids_and_order",
        ...
        "capabilities": {
            "planar_extrude_modifier_feature", "shell_modifier_feature",
            "bevel_chamfer_modifier_feature", "mirror_modifier_feature",
            "linear_pattern_modifier_feature", "boolean_modifier_feature",
    ...
    },
    {
        ...
        "script": "validate_stage3_feature_editing.py",
        ...
        "capabilities": {
            "stable_feature_id_parameter_edit", "feature_suppress_restore",
            "governed_feature_reorder", "feature_remove_tombstone",
            "feature_event_log_monotonic", "boolean_preexisting_dependency_preservation",
        },
        "environment_key": "stage3_feature_editing_validated_environment",
    },
    {
        "label": "Stage 3 Relation Kernel",
        "status_key": "VALIDATED_STAGE3_RELATION",
        "receipt_key": "stage3_relation_validation_receipt",
        "script": "validate_stage3_relations.py",
        ...
        "capabilities": {
            ...
            "relation_dependency_cycle_failure_gate",
            "missing_relation_object_failure_gate", "relation_remove_tombstone",
        },
        "environment_key": "stage3_relation_validated_environment",
    },
    {
        ...
        "script": "validate_stage3_relation_apply.py",
        ...
        "checks": {
            ...
            "relation_apply_event_log", "uncaptured_distance_apply_expected_failure",
        ...
        "failures": {
            "uncaptured_distance_direction", "ambiguous_distance_direction",
            "axis_parallel_multisolution", "external_transform_authority",
            "missing_relation_id",
        },
        "regressions": {
            "stage2_regression_in_same_job",
        ...
        "capabilities": {
            ...
            "external_transform_authority_apply_failure_gate",
        },
    ...
    },
    {
        ...
        "script": "validate_stage3_measurement.py",
        ...
        "checks": {
            ...
            "atomic_quantize_failure_no_partial_mutation", "world_ruler_editable_mesh",
            "world_ruler_minor_major_tick_counts", "world_ruler_metric_baseline",
        ...
        "failures": {
            ...
            "irregular_ruler_interval", "excessive_ruler_intervals",
            "excessive_ruler_labels",
        },
        "regressions": {
            "stage2_regression_in_same_job",
            "stage3_direct_regression_in_same_job",
        ...
        "capabilities": {
            ...
            "measurement_snapshot_active_dimensions", "exact_world_location_quantize",
            "exact_mm_nudge", "atomic_multi_object_quantize_preflight",
            "world_ruler_editable_mesh", "reference_guide_audit_exclusion",
            "native_increment_snap_configuration",
        },
        "environment_key": "stage3_measurement_validated_environment",
    },
    {
        "label": "Stage 3 Angular Datum",
        "status_key": "VALIDATED_STAGE3_ANGULAR_DATUM",
        "receipt_key": "stage3_angular_datum_validation_receipt",
        "script": "validate_stage3_angular_datum.py",
        "scope": "STAGE3_ANGULAR_DATUM_CONSTRUCTION",
        "checks": {
            ...
            "invalid_datum_axis_expected_failure", "invalid_datum_plane_expected_failure",
            "invalid_construction_line_expected_failure",
            "angular_operator_registration", "datum_operator_registration",
            "angular_datum_save_reopen_persistence",
        },
        "failures": {
            "external_transform_authority", "invalid_rotation_step",
            "irregular_angle_interval", "excessive_angle_intervals",
            "invalid_datum_axis", "invalid_datum_plane", "invalid_construction_line",
        },
        "regressions": {
            "stage2_regression_in_same_job",
            "stage3_direct_regression_in_same_job",
        ...
        "capabilities": {
            "angular_quantize_axis_mask", "angular_nudge_exact_degrees",
            "angle_guide_editable_reference_geometry", "datum_axis_metric_length",
            "datum_plane_metric_size", "construction_line_metric_length_offset",
            "angular_datum_reference_guide_audit_exclusion",
        },
    ...
    {
        "label": "Stage 3 Precision Inference",
        "status_key": "VALIDATED_STAGE3_PRECISION_INFERENCE",
        "receipt_key": "stage3_precision_inference_validation_receipt",
        "script": "validate_stage3_precision_inference.py",
        "scope": "STAGE3_PRECISION_INFERENCE_FOUNDATION",
        "checks": {
            "display_precision_state", "linear_display_formatting",
            "angular_display_formatting", "display_precision_range_failure",
            "signed_component_world_measurement", "component_origin_distance_metric",
            "aabb_axis_gap_metric", "aabb_clearance_authority_boundary",
            "mesh_endpoint_candidates", "mesh_midpoint_candidates",
            "mesh_face_center_candidates", "mesh_origin_candidate",
            "inference_no_solver_claim", "nearest_inference_metric_radius",
            "nearest_inference_kind_filter", "inference_radius_miss",
            "invalid_snap_radius_expected_failure", "candidate_limit_expected_failure",
            "nonmesh_inference_expected_failure",
            "precision_snapshot_combined_measurement",
            "precision_snapshot_inference_summary",
            "display_precision_operator_registration",
            "precision_snapshot_operator_registration",
            "display_precision_save_reopen_persistence",
            "precision_snapshot_save_reopen_persistence",
        },
        "failures": {
            "invalid_display_precision", "invalid_snap_radius",
            "candidate_limit", "nonmesh_inference",
        },
        "regressions": {
            "stage2_regression_in_same_job",
            "stage3_direct_regression_in_same_job",
        ...
        "capabilities": {
            "display_precision_state", "signed_component_world_measurement",
            "aabb_clearance_authority_boundary", "mesh_endpoint_candidates",
            "mesh_midpoint_candidates", "mesh_face_center_candidates",
            "nearest_inference_metric_radius",
            "precision_snapshot_save_reopen_persistence",
        },
        "environment_key": "stage3_precision_inference_validated_environment",
    },
    {
        "label": "Stage 3 Inference v2",
        "status_key": "VALIDATED_STAGE3_INFERENCE_V2",
        "receipt_key": "stage3_inference_v2_validation_receipt",
        "script": "validate_stage3_inference_v2.py",
        "scope": "STAGE3_INFERENCE_ENGINE_V2",
        "checks": {
            "parallel_inference", "collinear_inference", "perpendicular_inference",
            "intersection_inference", "skew_perpendicular_distance",
            "line_relation_metric_tolerances", "line_relation_no_solver_authority",
            "zero_direction_expected_failure",
            "invalid_angular_tolerance_expected_failure",
            "invalid_linear_tolerance_expected_failure",
            "mesh_edge_relation_wrapper", "mesh_edge_ole_provenance",
            "invalid_edge_index_expected_failure", "extension_line_projection",
            "extension_only_outside_segment", "extension_snap_radius",
            "extension_no_constraint_authority",
            "invalid_extension_radius_expected_failure",
            "world_axis_lock_projection", "axis_lock_no_transform_mutation",
            "invalid_axis_lock_expected_failure", "tracking_point_monotonic_ids",
            "tracking_point_metric_nearest", "tracking_point_radius_miss",
            "tracking_point_remove_by_id",
            "missing_tracking_point_expected_failure",
            "invalid_tracking_radius_expected_failure",
            "cursor_tracking_operator_registration",
            "inference_v2_snapshot_operator_registration",
            "inference_v2_no_solver_snapshot",
            "tracking_point_save_reopen_persistence",
            "inference_v2_snapshot_save_reopen_persistence",
        },
        "failures": {
            "invalid_angular_tolerance", "invalid_axis_lock", "invalid_edge_index",
            "invalid_extension_radius", "invalid_linear_tolerance",
            "invalid_tracking_radius", "missing_tracking_point", "zero_direction",
        },
        "regressions": {
            "stage2_regression_in_same_job",
            "stage3_direct_regression_in_same_job",
        ...
        "capabilities": {
            "line_parallel_inference", "line_perpendicular_inference",
            "line_collinear_inference", "line_intersection_inference",
            "mesh_edge_relation_wrapper", "extension_line_projection",
            "world_axis_lock_projection", "temporary_tracking_points",
            "tracking_point_metric_nearest", "inference_v2_no_solver_snapshot",
        },
        "environment_key": "stage3_inference_v2_validated_environment",
    },
    {
        "label": "Stage 3 Mesh Clearance",
        "status_key": "VALIDATED_STAGE3_MESH_CLEARANCE",
        "receipt_key": "stage3_mesh_clearance_validation_receipt",
        "script": "validate_stage3_mesh_clearance.py",
        "scope": "STAGE3_EVALUATED_MESH_CLEARANCE",
        "checks": {
            "depsgraph_evaluated_mesh_with_modifier", "evaluated_mesh_triangulation",
            "true_mesh_surface_distance_metric", "modifier_aware_clearance",
            "clearance_witness_points", "mesh_clearance_ole_provenance",
            "mesh_clearance_geometry_source", "mesh_clearance_cad_brep_boundary",
            "touching_surface_zero_clearance", "same_object_expected_failure",
            "triangle_pair_budget_expected_failure",
            "triangle_count_budget_expected_failure",
            "negative_zero_tolerance_expected_failure",
            "invalid_pair_budget_expected_failure", "nonmesh_expected_failure",
            "mesh_clearance_operator_registration",
            "exact_two_mesh_selection_failure_gate",
            "mesh_clearance_snapshot_persistence",
            "mesh_clearance_save_reopen_persistence",
        },
        "failures": {
            "same_object", "triangle_pair_budget", "triangle_count_budget",
            "negative_zero_tolerance", "invalid_pair_budget", "nonmesh",
            "exact_two_mesh_selection",
        },
        "regressions": {
            "stage2_regression_in_same_job",
            "stage3_direct_regression_in_same_job",
        ...
        "capabilities": {
            "depsgraph_evaluated_mesh_with_modifier", "evaluated_mesh_triangulation",
            "true_mesh_surface_distance_metric", "modifier_aware_clearance",
            "clearance_witness_points", "mesh_clearance_cad_brep_boundary",
            "triangle_pair_budget_failure_gate",
        },
        "environment_key": "stage3_mesh_clearance_validated_environment",
    },
    {
        "label": "Stage 3 Procedural",
        "status_key": "VALIDATED_STAGE3_PROCEDURAL",
        "receipt_key": "stage3_procedural_validation_receipt",
        "script": "validate_stage3_procedural.py",
        ...
        "checks": {
            ...
            "geometry_nodes_tree_creation", "geometry_nodes_modifier_binding",
            "geometry_nodes_passthrough_evaluation", "geometry_nodes_ole_provenance",
        ...
        "capabilities": {
            "parameter_constraint_metadata_mutation_api",
            "geometry_nodes_support_probe",
        },
        "environment_key": "stage3_procedural_validated_environment",
    },
]
...
def validate_stage(capability, status, stage):
    ...
    if (
        receipt.get("runtime_id") != capability.get("runtime_id")
        or receipt.get("runtime_version") != capability.get("runtime_version")
    ):
    ...
    if receipt.get("source_fingerprint_sha256") != expected:
        fail(
            f"{stage['label']} receipt stale: "
            f"{receipt.get('source_fingerprint_sha256')} != {expected}"
        )
    ...
    if (
        host.get("blender_version") != "5.1.2"
        or host.get("checksum_manifest_result") != "PASS"
        or not host.get("blender_archive_sha256")
    ):
    ...
    if (
        environment.get("source_fingerprint_sha256") != expected
        or environment.get("workflow_run_id") != workflow.get("run_id")
...
def main():
    ...
    capability = json.loads(
        (PIPELINE_ROOT / "BLENDER_RUNTIME_CAPABILITY.json").read_text(encoding="utf-8")
    )
    schema = json.loads(
        (ADDON_ROOT / "workbench_manifest.schema.json").read_text(encoding="utf-8")
    )
    ...
    if (
        ...
        != "OLEANDER_BLENDER_WORKBENCH_MANIFEST_v0.2"
    ):
    ...
    receipts = {
        stage["label"]: validate_stage(capability, status, stage)
        for stage in STAGES
    }
    ...
    for label, receipt in receipts.items():
        ...
        if (
            package.get("sha256") != canonical_package.get("sha256")
            or package.get("size_bytes") != canonical_package.get("size_bytes")
        ):
            fail(f"{label} receipt does not reference same Extension package as Stage 2")
        if (
            workflow.get("run_id") != canonical_workflow.get("run_id")
            or workflow.get("job_id") != canonical_workflow.get("job_id")
        ):
    ...
    required_not_implemented = {
        ...
        "multi_relation_solver", "solver_backed_angular_constraints",
        "cad_datum_feature_authority", "analytic_cad_brep_clearance",
        "engineering_fit_approval", "unbounded_large_mesh_clearance",
        "perpendicular_constraint_solver", "parallel_constraint_solver",
        "intersection_constraint_solver", "persistent_snap_constraint",
        "cad_sketch_solver", "feature_solver", "engineering_approval",
    ...
    required_boundaries = {
        "field_truth", "engineering_approval", "engineering_fit_approval",
        "manufacturing_release", "constructability", "constraint_solver",
        "iterative_solver", "multi_relation_solver", "solver_backed_angular_constraints",
        "cad_datum_feature_authority", "analytic_cad_brep_clearance",
        "unbounded_large_mesh_clearance", "automatic_transform_mutation",
        "perpendicular_constraint_solver", "parallel_constraint_solver",
        "intersection_constraint_solver", "persistent_snap_constraint",
        "cad_sketch_solver", "cad_brep", "viewport_grid_dimensional_authority",
        "screen_space_ruler_dimensional_authority",
        "screen_space_angle_dimensional_authority", "design_pass",
    }
        ...
        json.dumps(
            {
                ...
                "source_fingerprints": {
                    stage["label"]: source_fingerprint(
                        RUNTIME_ROOT / "tests" / stage["script"]
                    )
                    for stage in STAGES
                },
                "note": (
                    "Static PASS validates twelve-layer receipt/contract integrity; "
