...
STAGES = [
    ...
    {"label":"Stage 3 Inference v2","status_key":"VALIDATED_STAGE3_INFERENCE_V2","receipt_key":"stage3_inference_v2_validation_receipt","script":"validate_stage3_inference_v2.py","scope":"STAGE3_INFERENCE_ENGINE_V2","checks":{"parallel_inference","collinear_inference","perpendicular_inference","intersection_inference","skew_perpendicular_distance","line_relation_metric_tolerances","line_relation_no_solver_authority","zero_direction_expected_failure","invalid_angular_tolerance_expected_failure","invalid_linear_tolerance_expected_failure","mesh_edge_relation_wrapper","mesh_edge_ole_provenance","invalid_edge_index_expected_failure","extension_line_projection","extension_only_outside_segment","extension_snap_radius","extension_no_constraint_authority","invalid_extension_radius_expected_failure","world_axis_lock_projection","axis_lock_no_transform_mutation","invalid_axis_lock_expected_failure","tracking_point_monotonic_ids","tracking_point_metric_nearest","tracking_point_radius_miss","tracking_point_remove_by_id","missing_tracking_point_expected_failure","invalid_tracking_radius_expected_failure","cursor_tracking_operator_registration","inference_v2_snapshot_operator_registration","inference_v2_no_solver_snapshot","tracking_point_save_reopen_persistence","inference_v2_snapshot_save_reopen_persistence"},"failures":{"zero_direction","invalid_angular_tolerance","invalid_linear_tolerance","invalid_edge_index","invalid_extension_radius","invalid_axis_lock","missing_tracking_point","invalid_tracking_radius"},"regressions":{"stage2_regression_in_same_job","stage3_direct_regression_in_same_job","stage3_feature_stack_regression_in_same_job","stage3_feature_editing_regression_in_same_job","stage3_relation_regression_in_same_job","stage3_relation_apply_regression_in_same_job","stage3_measurement_regression_in_same_job","stage3_angular_datum_regression_in_same_job","stage3_precision_inference_regression_in_same_job"},"capabilities":{"parallel_inference","perpendicular_inference","collinear_inference","intersection_inference","extension_line_projection","world_axis_lock_projection","tracking_point_monotonic_ids","inference_v2_no_solver_snapshot"},"environment_key":"stage3_inference_v2_validated_environment"},
    {"label":"Stage 3 Mesh Clearance","status_key":"VALIDATED_STAGE3_MESH_CLEARANCE","receipt_key":"stage3_mesh_clearance_validation_receipt","script":"validate_stage3_mesh_clearance.py","scope":"STAGE3_EVALUATED_MESH_CLEARANCE","checks":{"depsgraph_evaluated_mesh_with_modifier","evaluated_mesh_triangulation","true_mesh_surface_distance_metric","modifier_aware_clearance","clearance_witness_points","mesh_clearance_ole_provenance","mesh_clearance_geometry_source","mesh_clearance_cad_brep_boundary","touching_surface_zero_clearance","same_object_expected_failure","triangle_pair_budget_expected_failure","triangle_count_budget_expected_failure","negative_zero_tolerance_expected_failure","invalid_pair_budget_expected_failure","nonmesh_expected_failure","mesh_clearance_operator_registration","exact_two_mesh_selection_failure_gate","mesh_clearance_snapshot_persistence","mesh_clearance_save_reopen_persistence"},"failures":{"same_object","triangle_pair_budget","triangle_count_budget","negative_zero_tolerance","invalid_pair_budget","nonmesh","exact_two_mesh_selection"},"regressions":{"stage2_regression_in_same_job","stage3_direct_regression_in_same_job","stage3_feature_stack_regression_in_same_job","stage3_feature_editing_regression_in_same_job","stage3_relation_regression_in_same_job","stage3_relation_apply_regression_in_same_job","stage3_measurement_regression_in_same_job","stage3_angular_datum_regression_in_same_job","stage3_precision_inference_regression_in_same_job","stage3_inference_v2_regression_in_same_job"},"capabilities":{"depsgraph_evaluated_mesh_with_modifier","true_mesh_surface_distance_metric","modifier_aware_clearance","clearance_witness_points","mesh_clearance_cad_brep_boundary","mesh_clearance_save_reopen_persistence"},"environment_key":"stage3_mesh_clearance_validated_environment"},
...
def main():
    ...
    required_not_implemented = {"cad_brep_sidecar","solver_backed_sketch_constraints","constraint_solver","multi_relation_solver","solver_backed_angular_constraints","cad_datum_feature_authority","analytic_cad_brep_clearance","engineering_fit_approval","unbounded_large_mesh_clearance","perpendicular_constraint_solver","parallel_constraint_solver","intersection_constraint_solver","persistent_snap_constraint","cad_sketch_solver","feature_solver","engineering_approval","manufacturing_release"}
    ...
    required_boundaries = {"field_truth","engineering_approval","engineering_fit_approval","manufacturing_release","constructability","constraint_solver","iterative_solver","multi_relation_solver","solver_backed_angular_constraints","cad_datum_feature_authority","analytic_cad_brep_clearance","unbounded_large_mesh_clearance","automatic_transform_mutation","perpendicular_constraint_solver","parallel_constraint_solver","intersection_constraint_solver","persistent_snap_constraint","cad_sketch_solver","cad_brep","viewport_grid_dimensional_authority","screen_space_ruler_dimensional_authority","screen_space_angle_dimensional_authority","design_pass"}
