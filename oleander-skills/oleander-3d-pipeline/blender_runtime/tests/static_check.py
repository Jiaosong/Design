...
contracts, nine independently fingerprint-bound real-Blender receipts,
...
STAGES = [
    {
        "label":"Stage 2","status_key":"VALIDATED_STAGE2_HEADLESS","receipt_key":"validation_receipt",
        "script":"validate_stage2.py","scope":"STAGE2_HEADLESS_CORE_AND_EXTENSION_PACKAGE",
        "checks":{"registration","persistent_metadata","duplicate_ole_id_expected_failure","identity_collision_repair_operator","missing_dependency_expected_failure","dependency_cycle_expected_failure","dependency_graph","stale_propagation","geometry_baseline_diff","configuration_capture_restore","bom_grouping_and_conflict_detection","review_state_separation","scene_unit_scale_round_trip","blend_save_reopen_persistence","audit_v0.2","manifest_v0.2"},
        "failures":{"duplicate_ole_id_detect_and_repair","missing_dependency_expected_failure","dependency_cycle_expected_failure"},
        "capabilities":{"dependency_graph_resolution","stale_dependency_propagation","geometry_baseline_diff","review_state_separation","export_manifest_v0.2_core"},
        "environment_key":"validated_environment",
    },
    {
        "label":"Stage 3 Direct","status_key":"VALIDATED_STAGE3_DIRECT","receipt_key":"stage3_direct_validation_receipt",
        "script":"validate_stage3_direct.py","scope":"STAGE3_DIRECT_MODELING",
        "checks":{"direct_metric_dimensions_operator","direct_dimensions_applied_scale","direct_geometry_change_stale_propagation","direct_operation_metric_record","linear_duplicate_operator","linear_duplicate_unique_ole_ids","linear_duplicate_stable_source_provenance","linear_duplicate_linked_mesh","linear_duplicate_metric_spacing","post_direct_audit_no_duplicate_ids"},
    ...
    {
        "label":"Stage 3 Feature Stack","status_key":"VALIDATED_STAGE3_FEATURE_STACK","receipt_key":"stage3_feature_stack_validation_receipt",
        "script":"validate_stage3_features.py","scope":"STAGE3_DIRECT_FEATURE_STACK",
        "checks":{"planar_extrude_modifier_feature","planar_extrude_metric_depth","planar_extrude_evaluated_geometry","nonplanar_extrude_expected_failure","shell_modifier_feature","bevel_chamfer_modifier_feature","mirror_modifier_feature","linear_pattern_modifier_feature","linear_pattern_metric_spacing","feature_history_stable_ids_and_order","feature_stack_order_drift_expected_failure","feature_geometry_change_stale_propagation","boolean_modifier_feature","boolean_cutter_ole_provenance","boolean_dependency_graph_binding","boolean_cutter_change_stale_propagation","feature_stack_save_reopen_persistence"},
        ...
        "capabilities":{"planar_extrude_modifier_feature","shell_modifier_feature","bevel_chamfer_modifier_feature","mirror_modifier_feature","linear_pattern_modifier_feature","boolean_modifier_feature","feature_history_stable_ids_and_order"},
        "environment_key":"stage3_feature_stack_validated_environment",
    },
    {
        "label":"Stage 3 Feature Editing","status_key":"VALIDATED_STAGE3_FEATURE_EDITING","receipt_key":"stage3_feature_editing_validation_receipt",
        "script":"validate_stage3_feature_editing.py","scope":"STAGE3_FEATURE_EDITING",
        "checks":{"stable_feature_id_parameter_edit","feature_parameter_edit_hits_real_modifier","feature_edit_revision_increment","feature_edit_downstream_stale_propagation","feature_suppress_restore","feature_suppression_history_modifier_sync","governed_feature_reorder","governed_reorder_history_order_sync","feature_remove_tombstone","feature_event_log_monotonic","boolean_dependency_added_by_feature_provenance","boolean_feature_owned_dependency_cleanup","boolean_preexisting_dependency_preservation","unknown_feature_id_expected_failure","feature_edit_save_reopen_persistence","tombstone_save_reopen_persistence","event_log_save_reopen_persistence"},
        "failures":{"unknown_feature_id"},
        "regressions":{"stage2_regression_in_same_job","stage3_direct_regression_in_same_job","stage3_feature_stack_regression_in_same_job"},
        "capabilities":{"stable_feature_id_parameter_edit","feature_suppress_restore","governed_feature_reorder","feature_remove_tombstone","feature_event_log_monotonic","boolean_preexisting_dependency_preservation"},
        "environment_key":"stage3_feature_editing_validated_environment",
    },
    {
        "label":"Stage 3 Relation Kernel","status_key":"VALIDATED_STAGE3_RELATION","receipt_key":"stage3_relation_validation_receipt",
        "script":"validate_stage3_relations.py","scope":"STAGE3_RELATION_KERNEL",
        "checks":{"stable_relation_id_registry","driver_driven_ole_provenance","scene_unit_metric_contract_independent_expectation","origin_distance_capture_current_metric","origin_distance_tolerance_evaluation","axis_offset_signed_metric_evaluation","axis_parallel_angular_evaluation","relation_solver_claim_false","relation_dependency_graph_binding","relation_failure_driven_stale","relation_failure_downstream_stale_propagation","relation_restore_pass","duplicate_relation_expected_failure","relation_dependency_cycle_expected_failure","relation_cycle_failure_no_registry_pollution","relation_cycle_failure_no_dependency_mutation","missing_relation_object_expected_failure","relation_dependency_added_by_relation_provenance","relation_owned_dependency_cleanup","relation_preexisting_dependency_preservation","relation_remove_tombstone","relation_event_log_monotonic","relation_registry_save_reopen_persistence","relation_tombstone_save_reopen_persistence","relation_event_log_save_reopen_persistence"},
        "failures":{"duplicate_active_relation","relation_dependency_cycle","missing_relation_object"},
        "regressions":{"stage2_regression_in_same_job","stage3_direct_regression_in_same_job","stage3_feature_stack_regression_in_same_job","stage3_feature_editing_regression_in_same_job"},
        "capabilities":{"stable_relation_id_registry","origin_distance_tolerance_evaluation","relation_dependency_graph_binding","relation_failure_downstream_stale_propagation","relation_dependency_cycle_failure_gate","missing_relation_object_failure_gate","relation_remove_tombstone"},
        "environment_key":"stage3_relation_validated_environment",
    },
    {
        "label":"Stage 3 Relation Apply","status_key":"VALIDATED_STAGE3_RELATION_APPLY","receipt_key":"stage3_relation_apply_validation_receipt",
        "script":"validate_stage3_relation_apply.py","scope":"STAGE3_RELATION_APPLY",
        "checks":{"axis_offset_one_shot_apply","axis_offset_preserves_orthogonal_world_coordinates","axis_offset_restores_relation_pass","origin_coincident_one_shot_apply","origin_distance_pass_reference_capture","origin_distance_reference_direction_provenance","origin_distance_one_shot_restore","origin_distance_restores_captured_direction","relation_apply_solver_claim_false","relation_apply_revision","relation_apply_downstream_stale_propagation","relation_apply_event_log","uncaptured_distance_apply_expected_failure","uncaptured_distance_failure_no_geometry_mutation","ambiguous_distance_direction_expected_failure","axis_parallel_multisolution_expected_failure","axis_parallel_failure_no_rotation_mutation","external_transform_authority_expected_failure","external_authority_failure_no_transform_mutation","missing_relation_apply_expected_failure","relation_apply_reference_save_reopen_persistence","relation_apply_revision_save_reopen_persistence","relation_apply_event_save_reopen_persistence"},
        "failures":{"uncaptured_distance_direction","ambiguous_distance_direction","axis_parallel_multisolution","external_transform_authority","missing_relation_id"},
    ...
    {
        "label":"Stage 3 Measurement","status_key":"VALIDATED_STAGE3_MEASUREMENT","receipt_key":"stage3_measurement_validation_receipt",
        "script":"validate_stage3_measurement.py","scope":"STAGE3_MEASUREMENT_SCALE_RULER",
        "checks":{"measurement_profile_scene_scale_preservation","scene_unit_mm_round_trip","measurement_snapshot_active_dimensions","measurement_snapshot_pair_origin_distance","exact_world_location_quantize","quantize_axis_mask_preservation","quantize_downstream_stale_propagation","exact_mm_nudge","external_transform_authority_quantize_failure","external_authority_failure_no_transform_mutation","atomic_multi_object_quantize_preflight","atomic_quantize_failure_no_partial_mutation","world_ruler_editable_mesh","world_ruler_minor_major_tick_counts","world_ruler_metric_baseline","world_ruler_major_labels_with_units","world_ruler_non_rendering_reference_scope","reference_guide_audit_exclusion","irregular_ruler_interval_expected_failure","excessive_ruler_intervals_expected_failure","excessive_ruler_labels_expected_failure","native_increment_snap_configuration","measurement_profile_save_reopen_persistence","measurement_snapshot_save_reopen_persistence","world_ruler_save_reopen_persistence","measurement_event_log_save_reopen_persistence"},
        "failures":{"external_transform_authority","atomic_batch_transform_authority","irregular_ruler_interval","excessive_ruler_intervals","excessive_ruler_labels"},
        "regressions":{"stage2_regression_in_same_job","stage3_direct_regression_in_same_job","stage3_feature_stack_regression_in_same_job","stage3_feature_editing_regression_in_same_job","stage3_relation_regression_in_same_job","stage3_relation_apply_regression_in_same_job"},
        "capabilities":{"measurement_profile_scene_scale_preservation","measurement_snapshot_active_dimensions","exact_world_location_quantize","exact_mm_nudge","atomic_multi_object_quantize_preflight","world_ruler_editable_mesh","reference_guide_audit_exclusion","native_increment_snap_configuration"},
    ...
    },
    {
        ...
        "script":"validate_stage3_angular_datum.py","scope":"STAGE3_ANGULAR_DATUM_CONSTRUCTION",
        "checks":{"angular_quantize_axis_mask","angular_quantize_metric_degree_contract","angular_quantize_downstream_stale","angular_nudge_exact_degrees","angular_batch_transform_authority_preflight","angular_batch_failure_no_partial_mutation","angle_guide_editable_reference_geometry","angle_guide_metric_radius","angle_guide_minor_major_interval_contract","datum_axis_metric_length","datum_plane_metric_size","construction_line_metric_length_offset","angular_datum_reference_guide_audit_exclusion","invalid_rotation_step_expected_failure","irregular_angle_interval_expected_failure","excessive_angle_intervals_expected_failure","invalid_datum_axis_expected_failure","invalid_datum_plane_expected_failure","invalid_construction_line_expected_failure","angular_operator_registration","datum_operator_registration","angular_datum_save_reopen_persistence"},
        "failures":{"external_transform_authority","invalid_rotation_step","irregular_angle_interval","excessive_angle_intervals","invalid_datum_axis","invalid_datum_plane","invalid_construction_line"},
        "regressions":{"stage2_regression_in_same_job","stage3_direct_regression_in_same_job","stage3_feature_stack_regression_in_same_job","stage3_feature_editing_regression_in_same_job","stage3_relation_regression_in_same_job","stage3_relation_apply_regression_in_same_job","stage3_measurement_regression_in_same_job"},
        "capabilities":{"angular_quantize_axis_mask","angular_nudge_exact_degrees","angle_guide_editable_reference_geometry","datum_axis_metric_length","datum_plane_metric_size","construction_line_metric_length_offset","angular_datum_reference_guide_audit_exclusion"},
        "environment_key":"stage3_angular_datum_validated_environment",
    },
    {
        "label":"Stage 3 Procedural","status_key":"VALIDATED_STAGE3_PROCEDURAL","receipt_key":"stage3_procedural_validation_receipt",
        "script":"validate_stage3_procedural.py","scope":"STAGE3_PROCEDURAL_FOUNDATION",
        "checks":{"parameter_metadata_mutation_api","parameter_metadata_sanitization","constraint_metadata_mutation_api","constraint_metadata_sanitization","metadata_mutation_does_not_claim_solver_geometry","geometry_nodes_tree_creation","geometry_nodes_modifier_binding","geometry_nodes_passthrough_evaluation","geometry_nodes_ole_provenance","geometry_nodes_explicit_no_solver_claim","geometry_nodes_save_reopen_persistence","parameter_constraint_save_reopen_persistence"},
...
def validate_stage(capability: dict, status: dict, stage: dict) -> dict:
    ...
    script = RUNTIME_ROOT / "tests" / stage["script"]
    expected = source_fingerprint(script)
...
def main() -> None:
    ...
    required_not_implemented = {
        "cad_brep_sidecar","solver_backed_sketch_constraints","constraint_solver","multi_relation_solver",
        "solver_backed_angular_constraints","cad_datum_feature_authority","feature_solver",
        "engineering_approval","manufacturing_release",
    }
    ...
    required_boundaries = {
        ...
        "constraint_solver","iterative_solver","multi_relation_solver","solver_backed_angular_constraints",
        "cad_datum_feature_authority","cad_brep","viewport_grid_dimensional_authority",
        "screen_space_ruler_dimensional_authority","screen_space_angle_dimensional_authority","design_pass",
    }
    ...
    output = {
        ...
        "source_fingerprints":{stage["label"]:source_fingerprint(RUNTIME_ROOT / "tests" / stage["script"]) for stage in STAGES},
        "note":"Static PASS validates nine-layer receipt/contract integrity; it is not a substitute for Blender runtime execution.",
    }
