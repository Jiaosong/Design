...
The module is intentionally no-loss: the main skill owns invariant rules; references deepen discipline, graphic, analysis, engineering-reality, visual hierarchy, detail density and jurisdiction logic without collapsing them into one checklist.
