  ...
  it("downgrades framework readback to PARTIAL when a canonical scalar field is retagged", async () => {
    ...
    const detail: KnowledgeReaderDetail = {
      ...
      review: {
        ...
        unknownBlockIds: [],
        relationReadback: {
          declared: { primaryDomain: 0, relatedDomain: 0, canonicalParent: 0, canonicalChild: 0, related: 0, primaryProject: 0, relatedProject: 0, source: 0, method: 0, replacement: 0, replacedDocument: 0 },
          indexedOutgoing: { primaryDomain: 0, relatedDomain: 0, canonicalParent: 0, canonicalChild: 0, related: 0, primaryProject: 0, relatedProject: 0, source: 0, method: 0, replacement: 0, replacedDocument: 0 },
          unresolvedTargets: [],
