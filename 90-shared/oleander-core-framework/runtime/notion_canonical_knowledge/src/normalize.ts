...
export function normalizePage(page: NotionPage): NormalizedPage {
  ...
  return {
    ...
    frameworkType: propertyText(properties[FIELDS.frameworkType]),
    objectPlane: "KNOWLEDGE",
    evidenceGrade: propertyText(properties[FIELDS.evidenceGrade]),
    freshnessState: null,
    authorityClass: null,
    informationRole: null,
    secondarySemantics: [],
    topicIds: [],
    claimIds: [],
    evidenceIds: [],
    capabilityLinks: [],
    functionLinks: [],
    informationEntityLinks: [],
    interfaceLinks: [],
    workMedium: [],
    designScale: propertyMultiSelectNames(properties[FIELDS.designScale]),
    artifactType: null,
    symptomTags: [],
    affectedRelationTags: [],
    toolCapability: [],
    readbackMethod: [],
    aliases: [],
    ...
    semanticRelatedIds: propertyRelationIds(properties[FIELDS.semanticRelated]),
    ...
    primaryProjectIds: propertyRelationIds(properties[FIELDS.primaryProject]),
    relatedProjectIds: propertyRelationIds(properties[FIELDS.relatedProjects]),
