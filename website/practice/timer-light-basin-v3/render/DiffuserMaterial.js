  ...
  root.traverse((obj)=>{
    ...
    if(/01_Upper_Housing/.test(n)){
      obj.material=new THREE.MeshPhysicalMaterial({
        color:0x77716f, metalness:0, roughness:0.55,
        clearcoat:0.012, clearcoatRoughness:0.76,
        ior:1.46, specularIntensity:0.52,
        specularColor:new THREE.Color(0xf2ece4)
      });
      obj.material.envMapIntensity=1.50;
      ...
      obj.material=new THREE.MeshPhysicalMaterial({
        color:0xb8babc, metalness:1, roughness:0.27,
