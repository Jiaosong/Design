(() => {
  ...
  const relationData = {
    culture: {
      ...
      projects: [['Project 01', '织造文化品牌系统', '#project-weaving'], ['Research', '文化参与中的所有权', '#projects']]
    },
    memory: {
      ...
      projects: [['Project 02', '地方记忆空间叙事', '#projects']]
    },
    symbol: {
      ...
      projects: [['Project 03', '公共符号与行为实验', '#projects']]
    },
    local: {
      ...
      projects: [['Research', '公共文化参与中的所有权问题', '#projects'], ['Project 01', '织造文化品牌系统', '#project-weaving']]
    },
    tradition: {
      ...
      projects: [['Project 01', '织造文化品牌系统', '#project-weaving']]
    }
  };
  ...
  const practiceData = {
    ...
    test: { code: '05 / TEST', title: '证据检查', question: '新的关系是否真的发生？', description: '检查理解、行为、参与和运营，不把完成形式或满意度自动视为关系变化。', methods: '任务测试 / 理解访谈 / 行为观察 / 相关者评审', outputs: '结果记录 / 失败记录 / 迭代决定 / 未来验证', evidence: '<a href="#change">织造项目：已验证、初步支持与未知</a>' },
...
(() => {
  ...
  const readingStates = {
    original: {
      ...
      detail: '织物磨损、修补与长期保存痕迹表明，它曾作为生活对象而非展示符号进入家庭。', confidence: 'CONFIDENCE / HIGH', tension: 42
    },
    current: {
      ...
      detail: '观察中，访客主要停留在成品与拍照区域；流程说明、工具和使用历史没有形成连续阅读入口。', confidence: 'CONFIDENCE / MEDIUM', tension: 78
    },
    intended: {
      source: '公众', sourceNote: '观看者与潜在参与者', action: '重新进入', target: '制作关系', targetNote: '材料、动作、使用与共同结果',
      status: 'EMERGING / PROPOSED', context: '品牌、包装、空间与参与式触点', evidence: '原型测试 + 设计假设',
      implication: '设计建立进入过程的条件，而不是声称已经完成文化延续。',
      detail: '展开、连接和共同生成使部分测试者能够描述交错结构；长期理解与公共参与仍需要真实运营验证。', confidence: 'CONFIDENCE / SUPPORTED', tension: 58
    }
  };
