...
def open_shell():
 d=closed();d.update({'topology_mode':'OPEN_SURFACE_APERTURE_SHELL','expected_aperture_boundary_edge_count':120,'aperture_boundary_loop_count':6,'derived_surface_method':'SUBD1_DENSE_APERTURE_LOOPS'});return d
class T(unittest.TestCase):
 ...
 def test_valid_open_shell(self):self.assertEqual(mod.validate(open_shell())['topology_mode'],'OPEN_SURFACE_APERTURE_SHELL')
