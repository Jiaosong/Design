...
**Architecture classification:** `OLEANDER_CURRENT_ARCHITECTURE_MAP_v2.0.md` controls architecture naming/counting. This document expands the eleven stable Runtime Layers of the single Current OLEANDER system architecture; it must not be read as eleven parallel architectures.
