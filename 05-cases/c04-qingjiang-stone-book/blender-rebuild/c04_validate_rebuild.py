...
receipt_path = os.path.join(out_dir, "C04_YUNSHUIYI_REBUILD_MASTER_v001_reopen_receipt.json")
required = [
...
passed = not missing and primary is not None and len(primary.data.vertices) > 0 and len(primary.data.polygons) > 0
receipt = {
    "schema_version": "1.0",
