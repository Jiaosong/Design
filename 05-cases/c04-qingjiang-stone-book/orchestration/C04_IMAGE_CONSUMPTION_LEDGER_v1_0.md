...
`IMG-C04-D-HERO-01` already violates the new ideal state because it was historically reused before this gate existed. It remains `LEGACY_MULTI_CONSUMED`, frozen as provenance, and prohibited from any additional project use.
