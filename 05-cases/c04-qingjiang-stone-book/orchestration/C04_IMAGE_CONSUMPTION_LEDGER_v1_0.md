...
| `IMG-C04-PHYS-RECOVERY-TECH-01` | parent `14_C04_PHYSICAL_RECOVERY_CURRENTIZED_v4.png` / parent SHA256 `0dc1cfc89b0499e3a74fcfcc867da5f8e9e4c014dcf3c9b8a5d879ecbe82ee1c`; bounds `[55,450,1270,930]`; child SHA256 `08ae30e2b1fb2046bf3cdd16f9e66598a5e0d8332fa3ec244acef83ed6c68943` | CH13-01 compatibility reservation only; not bound in source-bound S01 page | `RESERVED` | `LOCKED TO CH13-01 / UNBOUND / DO NOT REUSE` |
...
## CH13 S01 source-bound reservation｜PR #330

The original ODB-02 board was materialized into the active runtime from the user-provided source. Two genuinely distinct original-board child figures are recorded with explicit parent SHA, bounds, child SHA and semantic roles.
...
The older currentized technical figure remains **reserved but unbound** only to preserve the existing machine lock enforced by the Current image-consumption validator. It is not displayed in the current source-bound page and therefore creates no content-image repetition. It remains unavailable to all other consumer units.
